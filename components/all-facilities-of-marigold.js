...
import SoundProofHall from './sound-proof-hall'
import GuestRooms from './guest-rooms'
import ParkingFacilities from './parking-facilities'
import LiftAccessibility from './lift-accessibility'
import GeneratorBackup from './generator-backup'
import PremiumWashrooms from './premium-washrooms'
import AudioVisualEquipment from './audio-visual-equipment'
import PhotographyVideographyServices from './photography-videography-services'
import LocationWithHighwayAccess from './location-with-highway-access'

const AllFacilitiesOfMarigold = (props) => {
  return (
    <>
      <div
      ...
      >
        <div className="all-facilities-of-marigold-container1">
          ...
          <SpaciousVenue
            slogan={
              <Fragment>
                <span className="all-facilities-of-marigold-text100">
                  Elegance Redefined
                </span>
              </Fragment>
            }
            ...
            featureDescription={
              <Fragment>
                <span className="all-facilities-of-marigold-text104">
                  ...
                  designed to provide a refined, comfortable environment suited
                  to your unique event needs.
                </span>
              </Fragment>
            }
            feature1Description={
              <Fragment>
                <span className="all-facilities-of-marigold-text105">
                  ...
                  It’s ideal for creating a grand atmosphere and leaving a
                  lasting impression.
                </span>
              </Fragment>
            }
            feature2Description={
              <Fragment>
                <span className="all-facilities-of-marigold-text106">
                  ...
                  personalized setup options, ensuring every detail aligns with
                  your vision.
                </span>
              </Fragment>
            }
            featureDescription2={
              <Fragment>
                <span className="all-facilities-of-marigold-text107">
                  ...
                  Celebration Hall provides the perfect setting for a seamless
                  and memorable event.
                </span>
              </Fragment>
            }
            ...
            featureDescription3={
              <Fragment>
                <span className="all-facilities-of-marigold-text112">
                  ...
                  experiences, meticulously crafted to suit your unique event
            ...
            feature2Description2={
              <Fragment>
                <span className="all-facilities-of-marigold-text114">
                  ...
                  service from start to finish, allowing you and your guests to
            ...
            featureDescription31={
              <Fragment>
                <span className="all-facilities-of-marigold-text123">
                  ...
                  intimate gathering, our decor team brings creativity,
            ...
            featureDescription312={
              <Fragment>
                <span className="all-facilities-of-marigold-text149">
                  ...
                  thoughtfully designed to ensure a relaxing stay, whether for
                  wedding parties, corporate guests, or family gatherings.
                </span>
              </Fragment>
            }
            ...
            featureDescription3111={
              <Fragment>
                <span className="all-facilities-of-marigold-text162">
                  ...
                  inside and outside, we accommodate gatherings of any size,
            ...
            featureDescription321={
              <Fragment>
                <span className="all-facilities-of-marigold-text216">
                  ...
                  impactful presentations to unforgettable celebrations, our AV
                  setup enhances every occasion.
                </span>
              </Fragment>
            }
            ...
            featureDescription411={
              <Fragment>
                <span className="all-facilities-of-marigold-text229">
                  ...
                  highlight is beautifully captured, providing you with lasting
                  memories.
                </span>
              </Fragment>
            }
      ...
      <style jsx>
        {`
          ...
          .all-facilities-of-marigold-text101 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text102 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text103 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text104 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text105 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text106 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text109 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text110 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text111 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text112 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text113 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text114 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text119 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text120 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text121 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text122 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text123 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text124 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text125 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text126 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text127 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text130 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text131 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text132 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text133 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text134 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text135 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text136 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text137 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text138 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text139 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text140 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text145 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text146 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text147 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text148 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text149 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text150 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text151 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text152 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text153 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text156 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text157 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text158 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text159 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text160 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text161 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text162 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text163 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text164 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text165 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text166 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text171 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text172 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text173 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text174 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text175 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text184 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text185 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text186 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text187 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text188 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text189 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text190 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text191 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text192 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text193 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text194 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text199 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text200 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text201 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text202 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text203 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text204 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text205 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text206 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text207 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text210 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text211 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text212 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text213 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text214 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text215 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text216 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text217 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text218 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text219 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text220 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text225 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text226 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text227 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text228 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text229 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text230 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text231 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text232 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text233 {
            display: inline-block;
          }
          ...
          .all-facilities-of-marigold-text236 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text237 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text238 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text239 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text240 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text241 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text242 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text243 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text244 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text245 {
            display: inline-block;
          }
          .all-facilities-of-marigold-text246 {
            display: inline-block;
          }
...
AllFacilitiesOfMarigold.defaultProps = {
  featureDescription212111: undefined,
  rootClassName: '',
}

AllFacilitiesOfMarigold.propTypes = {
  featureDescription212111: PropTypes.element,
  rootClassName: PropTypes.string,
}

export default AllFacilitiesOfMarigold
