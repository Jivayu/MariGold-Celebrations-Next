        ...
        <div className="events-details-max-width UbuntuLight-14 thq-flex-column thq-section-max-width">
          ...
          >
            <div
              ...
              className="events-details-container3 UbuntuLight-14 thq-flex-column"
            >
              {isTermsVisible && (
                        ...
                        {props.content7 ?? (
                          <Fragment>
                            <span className="events-details-text31">
                              ...
                              moment of it extraordinary. Our venue is designed
                              to be the perfect backdrop for your celebration,
                              whether you&apos;re planning an elegant
                              traditional wedding or a chic, contemporary
                              reception. We work tirelessly to bring your vision
                              to life, ensuring your day is as special as the
                              love you share.
                            </span>
                          </Fragment>
                        )}
              ...
              {isPrivacyVisible && (
                <div className="events-details-container5">
                  <ul className="UbuntuLight-14 thq-flex-column">
                        ...
                        {props.content1 ?? (
                          <Fragment>
                            <span className="events-details-text62">
                              ...
                              unforgettable setting for your engagement
                              ceremony, where you can share this joyous moment
                            ...
                            {props.content3 ?? (
                              <Fragment>
                                <span className="events-details-text40">
                                  ...
                                  vision. Whether it’s a delicate floral display
                                  or a contemporary stage design, we ensure
                                  every detail is tailored to your taste, making
                                  your engagement ceremony both beautiful and
                                  memorable.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.content4 ?? (
                              <Fragment>
                                <span className="events-details-text61">
                                  ...
                                  offering a culinary experience that
                                  complements your celebration and delights your
                                  guests.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.content5 ?? (
                              <Fragment>
                                <span className="events-details-text57">
                                  ...
                                  that you can focus on making memories. From
                                  initial planning to the final farewell, we
                                  ensure your event runs smoothly and
                                  effortlessly.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.content6 ?? (
                              <Fragment>
                                <span className="events-details-text55">
                                  ...
                                  accommodate both intimate and grand
                                  gatherings, providing the perfect backdrop for
              ...
              {isRefundVisible && (
                <div className="events-details-container6">
                  <ul className="UbuntuLight-14 thq-flex-column">
                        ...
                        {props.content10 ?? (
                          <Fragment>
                            <span className="events-details-text51">
                              ...
                              offers an ideal setting for all your pre-wedding
                              functions, including Mehendi, Haldi, and Sangeet,
                            ...
                            {props.content11 ?? (
                              <Fragment>
                                <span className="events-details-text41">
                                  ...
                                  environment where family and friends can
                                  gather to celebrate these treasured rituals in
                                  style.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.content12 ?? (
                              <Fragment>
                                <span className="events-details-text34">
                                  ...
                                  or modern elements, our venue adapts
                            ...
                            {props.content13 ?? (
                              <Fragment>
                                <span className="events-details-text53">
                                  ...
                                  ensures that the venue is beautifully set up
                                  according to your theme, whether it&apos;s
                                  classic Indian motifs or modern chic designs,
                                  elevating the entire celebration.
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.content131 ?? (
                              <Fragment>
                                <span className="events-details-text36">
                                  ...
                                  favorites to international delicacies,
                                  ensuring that every bite complements the
                                  festive spirit of your pre-wedding functions.
                                </span>
                              </Fragment>
                            )}
                          </span>
