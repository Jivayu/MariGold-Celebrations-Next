    ...
    <>
      <div className={`faq14faq8 thq-section-padding ${props.rootClassName} `}>
        <div className="faq14-max-width thq-section-max-width">
          <div className="faq14-container10 UbuntuLight-14 thq-flex-column">
            <div className="faq14-section-title UbuntuLight-14 thq-flex-column">
              <h2 className="faq14-text10 h2 thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
            ...
            <div className="faq14-list UbuntuLight-14 thq-flex-column">
              ...
              <div className="faq14-faq1">
                ...
                >
                  <p className="faq14-faq1-question1 thq-body-large">
                    {props.faq1Question ?? (
                      <Fragment>
                        <span className="faq14-text26">What is OnConf?</span>
                      </Fragment>
                    )}
                  </p>
                    ...
                    {props.faq3Question ?? (
                      <Fragment>
                        <span className="faq14-text30">
                          How can I participate in OnConf?
                        </span>
                      </Fragment>
                    )}
                  </p>
                    ...
                    {props.faq4Question ?? (
                      <Fragment>
                        <span className="faq14-text27">
                          Is there a cost to attend OnConf?
                        </span>
                      </Fragment>
                    )}
                  </p>
                    ...
                    {props.faq5Question ?? (
                      <Fragment>
                        <span className="faq14-text32">
                          Can I connect with industry professionals during
                          OnConf?
                        </span>
                      </Fragment>
                    )}
          ...
          <div className="faq14-content1 UbuntuLight-14 thq-flex-column">
            <div className="faq14-content2">
              <h2 className="faq14-text18 h2 thq-heading-2">
                {props.heading2 ?? (
                  <Fragment>
                    <span className="faq14-text33">Still have a question?</span>
                  </Fragment>
                )}
              </h2>
            ...
            <button type="button" className="thq-button-filled">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="faq14-text29">Email us</span>
                  </Fragment>
                )}
              </span>
            </button>
