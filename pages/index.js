    ...
    <>
      <div className="home-container">
        ...
        <PricingPlans
          ...
          faq1Question={
            <Fragment>
              <span className="home-text164">Base Pax | People</span>
            </Fragment>
          }
          faq2Question={
            <Fragment>
          ...
          faq1Question1={
            <Fragment>
              <span className="home-text168">Plan A 650 Only</span>
            </Fragment>
          }
          faq1Question2={
            <Fragment>
          ...
          faq1Question12={
            <Fragment>
              <span className="home-text171">Plan A 650 Only</span>
            </Fragment>
          }
          faq1Question21={
            <Fragment>
              <span className="home-text172">Services &amp; Features</span>
            </Fragment>
          }
          faq1Question111={
            <Fragment>
              <span className="home-text173">Plan A 750 Only</span>
            </Fragment>
          }
          faq1Question112={
            <Fragment>
              <span className="home-text174">Plan A 700 Only</span>
            </Fragment>
          }
          faq1Question211={
            <Fragment>
              <span className="home-text175">For Plan C</span>
            </Fragment>
          }
          faq1Question212={
            <Fragment>
              <span className="home-text176">For Plan B</span>
            </Fragment>
          }
          faq1Question213={
            <Fragment>
        ...
        <GoogleReviews
          button={
            <Fragment>
              <span className="home-text181">Button</span>
            </Fragment>
          }
          text101={
            <Fragment>
              <span className="home-text182">marigoldcelebration.in</span>
            </Fragment>
          }
          content1={
            <Fragment>
          ...
          heading1={
            <Fragment>
              <span className="home-text184">Google Reviews - Best only</span>
            </Fragment>
          }
          text1013={
            <Fragment>
              <span className="home-text185">marigoldcelebration.in</span>
            </Fragment>
          }
          text1014={
            <Fragment>
              <span className="home-text186">marigoldcelebration.in</span>
            </Fragment>
          }
          text2101={
            <Fragment>
              <span className="home-text187">Verify Review</span>
            </Fragment>
          }
          text2171={
            <Fragment>
          ...
          text21013={
            <Fragment>
              <span className="home-text189">Verify Review</span>
            </Fragment>
          }
          text21014={
            <Fragment>
              <span className="home-text190">Verify Review</span>
            </Fragment>
          }
          text21713={
            <Fragment>
          ...
          text113251={
            <Fragment>
              <span className="home-text193">Atharva Diwate</span>
            </Fragment>
          }
          image1Title={
            <Fragment>
              <span className="home-text194">Image 1</span>
            </Fragment>
          }
          image2Title={
            <Fragment>
              <span className="home-text195">Corporate Event Venue</span>
            </Fragment>
          }
          image3Title={
            <Fragment>
              <span className="home-text196">Social Gathering Decor</span>
            </Fragment>
          }
          text1132513={
            <Fragment>
              <span className="home-text197">Atharva Diwate</span>
            </Fragment>
          }
          text1132514={
            <Fragment>
              <span className="home-text198">Atharva Diwate</span>
            </Fragment>
          }
          ...
          image2Description={
            <Fragment>
              <span className="home-text202">Our Grand Main Hall</span>
            </Fragment>
          }
          image3Description={
            <Fragment>
        ...
        <VideoGallery
          ...
          action23={
            <Fragment>
              <span className="home-text205">Google Business Profile</span>
            </Fragment>
          }
          review11={
            <Fragment>
          ...
          text21011={
            <Fragment>
              <span className="home-text207">Visit Gallery</span>
            </Fragment>
          }
          author1Name={
            <Fragment>
          ...
          author1Position={
            <Fragment>
              <span className="home-text209">marigoldcelebration.in</span>
            </Fragment>
          }
        ></VideoGallery>
        <Footer
          ...
          link2={
            <Fragment>
              <span className="home-text211">Facilities</span>
            </Fragment>
          }
          link3={
            <Fragment>
              <span className="home-text212">Gallery</span>
            </Fragment>
          }
          link4={
            <Fragment>
              <span className="home-text213">Events</span>
            </Fragment>
          }
          link5={
            <Fragment>
              <span className="home-text214">Contacts</span>
            </Fragment>
          }
          link6={
            <Fragment>
              <span className="home-text215">Corporate Events</span>
            </Fragment>
          }
          link7={
            <Fragment>
              <span className="home-text216">Weddings Plannings</span>
            </Fragment>
          }
          link8={
            <Fragment>
          ...
          link9={
            <Fragment>
              <span className="home-text220">Special Occasions</span>
            </Fragment>
          }
          link10={
            <Fragment>
              <span className="home-text221">Book Now</span>
            </Fragment>
          }
          content2={
            <Fragment>
          ...
          content3={
            <Fragment>
              <span className="home-text223">MariGold Celebration</span>
            </Fragment>
          }
          termsLink={
            <Fragment>
              <span className="home-text224">terms &amp; conditions.</span>
            </Fragment>
          }
          termsLink1={
            <Fragment>
              <span className="home-text225">T &amp; C</span>
            </Fragment>
          }
          cookiesLink={
            <Fragment>
              <span className="home-text226">cookie policy.</span>
            </Fragment>
          }
          privacyLink={
            <Fragment>
              <span className="home-text227">privacy policy.</span>
            </Fragment>
          }
          column1Title={
            <Fragment>
              <span className="home-text228">Contact Us</span>
            </Fragment>
          }
          column2Title={
            <Fragment>
              <span className="home-text229">Services</span>
            </Fragment>
          }
          cookiesLink1={
            <Fragment>
              <span className="home-text230">C &amp; P</span>
            </Fragment>
          }
          privacyLink1={
            <Fragment>
              <span className="home-text231">P P</span>
            </Fragment>
          }
